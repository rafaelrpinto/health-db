...
```shell
INFO app-logger: Initiating process.
INFO redis-logger: 31884 facilities processed so far...
INFO redis-logger: 66191 facilities processed so far...
INFO redis-logger: 99180 facilities processed so far...
INFO redis-logger: 129506 facilities processed so far...
INFO redis-logger: 171354 facilities processed so far...
INFO redis-logger: 208301 facilities processed so far...
INFO redis-logger: 243690 facilities processed so far...
redis-logger: Total facilities processed: 264780
INFO app-logger: Process complete.
```
...
```shell
1) "5671388:SMS RIO COORDENADORIA GERAL DE ATENCAO PRIMARIA AP 22"
2) "7383304:MARIA PINA SICILIANO"
3) "7737505:CARLA CALDAS MARQUES"
4) "5188024:CLINICA MEDICA ODONTOLOGICA RADIOLOGICA E AMBULATORIAL DA TI"
5) "3052664:JOSE ARAUJO SERVICOS MEDICOS LTDA"
6) "3603016:CENTRO DE GINECOLOGIA E OBSTETRICIA DRA ELIZABETH COSTA MART"
7) "5188032:GISELE CAZALE BONIOLI SERVICOS MEDICOS LTDA"
8) "5359686:CETOT RIO ORTOPEDIA ME"
9) "5701988:DAG SERVICOS MEDICOS"
10) "7379676:ANA CRISTINA DA SILVA PINTO TEIXEIRA"
```
